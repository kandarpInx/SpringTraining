...
//		System.out.println("Fruit name is "+fd1.getName()+", color is "+fd1.getColor()+", weight is "+fd1.getWeight());
		System.out.println(this.messageSource.getMessage("fruit.details", new Object[] {fd1.getName(), fd1.getColor(), fd1.getWeight()}, "Default message of fruit details", null));
