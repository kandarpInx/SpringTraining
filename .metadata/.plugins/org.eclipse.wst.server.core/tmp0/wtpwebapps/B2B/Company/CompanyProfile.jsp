            ...
            <div class="box-body pad">
                ...
                <%
                	...
                	try(Session s=HibernateUtil.getSessionFactory().openSession())
                	{
						...
						if(cr.getCompanyProfile()!=null)
						{
							profile=cr.getCompanyProfile().getCompany_profile();
							profile_id=cr.getCompanyProfile().getId();
						}		
						
						%>
						<form method="post" action="/B2B/CompanyProfileServlet">
                
                			<input type="hidden" name="id" value="<%= profile_id %>" />
                
			                <textarea name="company_profile" class="textarea" placeholder="Place some text here"
			                          style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><%= profile %></textarea>
