              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <%
                	try(Session s=HibernateUtil.getSessionFactory().openSession())
                	{
                		...
                		List<CompanyInboxOutbox> li=s.createQuery("from CompanyInboxOutbox cp where cp.companyRegistration.id=:company_id order by cp.id DESC", CompanyInboxOutbox.class)
                		...
                		for(CompanyInboxOutbox m:li)
                		{
                			...
                			<tr>
			                  <td><%= m.getId() %></td>
			                  <td><%= m.getFromCompanyRegistration().getCompany_name() %></td>
			                  <td><%= m.getMessage() %></td>                  			                  
			                </tr>
                			<%
                		}
