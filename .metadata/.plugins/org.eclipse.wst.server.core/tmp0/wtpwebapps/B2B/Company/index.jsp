  ...
  <div class="login-box-body">
    ...
    <form class="form validity" action="/B2B/CompanyRegistrationServlet" method="post">
      <div class="form-group has-feedback">
        <input type="email" class="form-control" placeholder="Enter Email" name="email" data-missing="This field is required" data-mismatch="Please include a valid emailid"  maxlength="45" minlength="10" required>
        <span class="glyphicon glyphicon-envelope form-control-feedback" id="slogo"></span>
      </div>
      <div class="form-group has-feedback">
        <input type="password" class="form-control" placeholder="Password" name="password" data-missing="This field is required" data-mismatch="Please include a valid password"  maxlength="12" minlength="6" required>
